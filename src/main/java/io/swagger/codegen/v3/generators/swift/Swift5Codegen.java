...
public class Swift5Codegen extends AbstractSwiftCodegen {
    ...
    public Swift5Codegen() {
        ...
        languageSpecificPrimitives.add("[String: AnyCodable]");
        ...
        typeMapping.put("object", "[String: AnyCodable]");
        typeMapping.put("Object", "[String: AnyCodable]");
    ...
    public void processOpts() {
        ...
        supportingFiles.add(new SupportingFile("CodableHelper.mustache",
                sourceFolder,
                "CodableHelper.swift"));
        supportingFiles.add(new SupportingFile("AnyCodable.mustache",
                sourceFolder,
                "AnyCodable.swift"));
        ...
        supportingFiles.remove(new SupportingFile("AlamofireImplementations.mustache",
                sourceFolder,
                "AlamofireImplementations.swift"));
        supportingFiles.remove(new SupportingFile("Cartfile.mustache",
                "",
                "Cartfile"));
        supportingFiles.remove(new SupportingFile("Extensions.mustache",
                sourceFolder,
                "Extensions.swift"));
        supportingFiles.remove(new SupportingFile("git_push.sh.mustache",
                "",
                "git_push.sh"));
    }
